...
public interface TAdminRoleMapper {
    ...
    void saveAdminAndRoleRelationship(@Param("adminId") Integer adminId, @Param("roleIds") List<Integer> ids);

    void deleteAdminAndRoleRelationship(@Param("adminId") Integer adminId, @Param("roleIds") List<Integer> ids);
}